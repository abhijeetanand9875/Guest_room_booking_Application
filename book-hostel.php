...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="center">Room  already booked by you</h3>
			<div align="center">
...
<input type="radio" value="1" name="foodstatus"> With Food(Rs 2000.00 Per DayExtra)
</div>
</div>	
...
<option value="">Select Duration in Day</option>
